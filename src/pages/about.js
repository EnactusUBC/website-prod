    ...
    return (
        ...
        <main className='flex flex-col w-full overflow-x-hidden bg-[#fbfcfd] text-dark'>
            <div className='bg-about bg-cover w-screen min-h-screen mt-20'>
                    ...
                    <div className='xl:mx-32 mx-4 sm:mx-20 3xl:mx-80 flex flex-col lg:flex-row justify-between lg:mb-32'>
                        <div className='xl:w-1/4 sm:w-4/5 my-4 lg:mr-4 xl:mr-0'>
                            <div className='flex items-center mb-2 xl:mb-6'>
                                ...
                                <img src='/aboutimages/lightbulbyellow.png'></img>
                            </div>
                        ...
                        <div className='xl:w-1/4 sm:w-4/5 my-4 lg:mx-4 xl:mx-0'>
                            <div className='flex items-center mb-2 xl:mb-6'>
                                ...
                                <img src='/aboutimages/mountainsyellow.png'></img>
                            </div>
                        ...
                        <div className='xl:w-1/4 sm:w-4/5 my-4 lg:mx-4 xl:mx-0'>
                            <div className='flex items-center mb-2 xl:mb-6'>
                                ...
                                <img src='/aboutimages/peopleyellow.png'></img>
                            </div>
                ...
                <img src='/aboutimages/bottomswoosh.png' className='w-full'></img>
            </div>
            <div className='flex lg:flex-row flex-col items-center mb-4 mx-6'>
                <img src='/aboutimages/execteam.jpg' className='lg:w-5/12 md:w-4/6 rounded-lg lg:ml-12 xl:ml-32 md:my-8 my-16 shadow-solid'></img>
            ...
            <img src='/aboutimages/bottomswoosh2.png' className='w-full'></img>
            <div className='flex items-center ml-4 lg:ml-20 xl:ml-32 mt-10'>
                <img src='/aboutimages/earth.png' className='w-20 lg:w-40 xl:w-60 relative hover:rotate-180 transition ease-linear duration-2000'></img>
