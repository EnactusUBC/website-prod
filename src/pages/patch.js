...
{/* All need to change */}
// import bannerPath from "../images/patch/PATCH-BANNER.jpg"
import bannerPath from "../images/patch/PATCH-BANNER2.png"
import logoPath from "../images/patch/Patch-logo.png"
import squarePhoto from "../images/patch/patch-photo1.png"
import longPhoto from "../images/patch/Patch-long.jpg"
import PD1 from "../images/patch/Annette.jpg"
import PD2 from "../images/patch/Cynthia-photo.png"
...
export default function Home() {
  return (
    <main>
      ...
      <div class="h-96 relative overflow-hidden" id="banner">
        ...
        <p class="z-20" style={{color: "#"}}>PATCH</p> {/* CHANGE */}
        </div>
      ...
      <div id="about-us" class="flex flex-col lg:flex-row items-center">
        <div id="about-us-text" className="p-16 lg:p-8 m-8 lg:p-32 lg:p-32 lg:max-w-[55%]">
          ...
          Project Patch is one of Enactus UBC’s social enterprises undergoing its most crucial stages of organization development. Our vision is to educate our community about fashion sustainability and taking action to create a change. In Patch, you will be able to contribute your ideas and bring your entrepreneurial vision to life as part of a diverse and dynamic team.
          </p>
        </div>
      ...
      {/* <div id="flexible" class="text-center" style={{padding: "6% 3% 4% 3%"}}>
        <p class="lg:my-7 my-3 p-4 text-xl lg:text-4xl font-bold">You get something here that’s flexible to what you wanna write</p>
      ...
      {/* PD PHOTOS */} {/* CHANGE */}
      <div id="PD-photos" class="flex justify-center m-16">
      <div class="flex flex-col items-center m-4">
          ...
          <a href="mailto:annettecchan@gmail.com"><p class="font-light text-sm lg:text-base text-white">Annette Chan</p></a>
        </div>
        <div class="flex flex-col items-center m-4">
          <div class="w-32 h-32 lg:w-52 lg:h-52">
          ...
          <p class="text-l mt-4 lg:text-xl font-bold text-white">Project Director</p>
          <a href="mailto:cynthia10.22chang@gmail.com"><p class="font-light text-sm lg:text-base text-white">Cynthia Wang</p></a>
        </div>
      </div>

      {/* SOCIAL MEDIA LINKS */} {/* CHANGE */}
      <div id="socials" class="flex justify-center space-x-4 lg:space-x-12 pt-8 pb-28">
        <a href="https://www.instagram.com/patch.ubc/" target="_blank" rel="noopener noreferrer">
          <Image class="hover:opacity-60 transition duration-300" src={ig} alt="instagram Enactus project" width={25} height={25} />
        </a>
        <a href="mailto:Projectpatch.ubc@gmail.com" target="_blank" rel="noopener noreferrer">
  ...
  <div
    style={{
      backgroundImage: "linear-gradient(#ffffff, #58376e)",
