...
{/* All need to change */}
import bannerPath from "../images/default-banner.jpg"
import logoPath from "../images/ENNOVATE-W.png"
import squarePhoto from "../images/bing-chilling.png"
import longPhoto from "../images/long-photo-1.png"
import smallPhoto from "../images/small-photo-1.png"
  ...
  return (
    <main>
      ...
      <div id="about-us" class="flex flex-col lg:flex-row items-center">
        <div id="about-us-text" className="p-16 lg:p-8 m-8 lg:p-32 lg:p-32 lg:max-w-[55%]">
          ...
          <p class="my-7 text-xl lg:text-2xl font-light"> {/* CHANGE */}
            Give a description about what the project is all about, like mission statements values etc. Talk about it as if you were on the front page of your own website. But phrase it so that people are hooked in and want to visit your own :DD
          </p>
        </div>
      ...
      <div class="flex justify-center items-center m-12">
        <Link href="/patch"><button class="button bg-transparent text-white border-2 border-white cursor-pointer transition duration-300 ease-in-out rounded-3xl hover:bg-white hover:text-sky-400 font-light" style={{ padding: "25px 80px", fontSize: "20px" }}>
          Website
        </button>
        </Link>
      </div>
      ...
      <div class="flex flex-col items-center m-4">
          <div class="w-32 h-32 lg:w-52 lg:h-52">
            <Image src={smallPhoto} alt="Square photo" width={"auto"} height={"auto"} style={{borderRadius: "50%"}}/>
          </div>
          <p class="text-l mt-4 lg:text-xl font-bold text-white">Project Director</p>
          <a href="mailto:internal.enactusubc@gmail.com"><p class="font-light text-sm lg:text-base text-white">Name of person</p></a>
        </div>
        <div class="flex flex-col items-center m-4">
          <div class="w-32 h-32 lg:w-52 lg:h-52">
            <Image src={smallPhoto} alt="Square photo" width={"auto"} height={"auto"} style={{borderRadius: "50%"}}/>
